  ...
  return (
    <div className="detail">
      {movie && (
        <>
          <Image
            src={IMAGES_DETAIL_ENDPOINT + movie.backdrop_path}
          ...
          <div className="detail-data">
            <Row justify="space-between" className="detail-data-body">
              <Col span={6} className="detail-data-body-image">
                <Image
                  src={IMAGES_ENDPOINT + movie.poster_path}
                  alt={movie.title}
                  preview={false}
                  height={350}
                  width={240}
                  className="detail-data-body-image"
              ...
              <Col span={17}>
                ...
                <div className="detail-data-body-vote">
